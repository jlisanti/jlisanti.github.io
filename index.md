...
<html>
	...
	<body class="is-preload">
		...
		<!-- Header -->
			<section id="header">
				<header>
					<span class="image avatar"><img src="images/profile_photo.png" alt="" /></span>
					<h1 id="logo"><a href="#">Joel Lisanti</a></h1>
					<p>Mechanical & Aerospace Engineer <br> 
					+ <br>
				Cycling, climbing, and cooking</p>
				</header>
				<nav id="nav">
					<ul>
				...
				<footer>
					<ul class="icons">
						...
						<li><a href="mailto: joel.c.lisanti@gmail.com" class="icon solid fa-envelope"><span class="label">Email</span></a></li>
					</ul>
				</footer>
			</section>
                        ...
                        <!-- Four -->
							<section id="four">
								<div class="container">
									...
									<ul class="inner">
										<li>B.S. Aerospace Engineering <br> North Carolina State University (NCSU) <br> 2008 - 2012</li>
									</ul>
								</div>
							</section>
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
				...
				<!-- Footer -->
					<section id="footer">
						<div class="container">
							<ul class="copyright">
								<li>2021 &copy; Joel Lisanti. <br> All rights reserved.</li>
							</ul>
						</div>
					</section>
